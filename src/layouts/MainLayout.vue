  ...
  <q-layout view="lhh Lpr lff">
    <q-header class="transparent-header q-pl-150 q-pr-150">
      <q-toolbar class="q-pl-none q-pr-none">
        ...
        <q-btn v-else flat dense round icon="menu" aria-label="Menu" @click="toggleLeftDrawer" />
      </q-toolbar>
    </q-header>
    ...
    <q-drawer v-model="leftDrawerOpen" bordered side="right">
      <q-list>
        <q-item>
          <q-btn flat icon="close" @click="leftDrawerOpen = false" aria-label="Close" class="q-ml-auto q-pr-none" />
        </q-item>
